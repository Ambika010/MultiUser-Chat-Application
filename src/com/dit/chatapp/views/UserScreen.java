...
public class UserScreen extends JFrame {
	...
	private void doLogin() {
		...
		char[] password = passwordField.getPassword(); //when you print this output will be in the form of ClassName@HashCode(Hexa) (So password is not revealed)
	...
	private void register() {
		String userid = useridtxt.getText();
		//String password = passwordField.getText(); //getText method reveals the password so for security reasons new method has been made 
		char[] password = passwordField.getPassword(); //when you print this output will be in the form of ClassName@HashCode(Hexa) (So password is not revealed)
		//userDAO usr = new userDAO();
		userDTO usr1 = new userDTO(userid, password);
		try {
